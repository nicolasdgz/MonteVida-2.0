...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMsg((err instanceof Error ? err.message : null) || "Error de conexión. Inténtalo de nuevo.");
  ...
  return (
    <>
      ...
      <section className="overflow-hidden py-20 bg-surface">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex flex-col xl:flex-row gap-7.5">
            <div className="xl:max-w-[370px] w-full bg-surface rounded-3xl shadow-neu">
              ...
              <div className="p-4 sm:p-7.5">
                <div className="flex flex-col gap-4">
                  ...
                  <p className="flex items-center gap-4">
                    ...
                    Teléfono/WhatsApp: +51 973 791 539
                  </p>
            ...
            <div className="xl:max-w-[770px] w-full bg-surface rounded-3xl shadow-neu p-4 sm:p-7.5 xl:p-10">
              {errorMsg && (
                <div className="mb-5 p-4 text-red-600 bg-red-100 rounded-md">
                  {errorMsg}
                </div>
              )}
              <form onSubmit={handleSubmit}>
                <div className="mb-5">
                  <label className="block mb-2.5 font-medium text-dark">
                    Tipo de Persona <span className="text-red">*</span>
                  </label>
                  <div className="flex items-center gap-6">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        checked={formData.entityType === "Persona Natural"}
                        onChange={handleChange}
                        className="w-4 h-4 text-primary bg-gray-1 border-gray-3 focus:ring-primary"
                      />
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        name="entityType"
                        value="Empresa"
                        checked={formData.entityType === "Empresa"}
                        onChange={handleChange}
                        className="w-4 h-4 text-primary bg-gray-1 border-gray-3 focus:ring-primary"
                      />
                      <span>Empresa</span>
                ...
                <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                  <div className="w-full">
                    ...
                    <input
                      ...
                      placeholder="Juan"
                      required
                      className="rounded-xl border-0 bg-surface shadow-neu-inset placeholder:text-dark-5 w-full py-2.5 px-5 outline-none duration-200 focus:ring-2 focus:ring-primary/30"
                    />
                  </div>
                ...
                <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                  ...
                  {formData.entityType === "Empresa" && (
                    <div className="w-full">
                      <label htmlFor="ruc" className="block mb-2.5">
                        RUC
                      </label>
                ...
                <div className="mb-7.5">
                  ...
                  <textarea
                    ...
                    required
                    className="rounded-xl border-0 bg-surface shadow-neu-inset placeholder:text-dark-5 w-full p-5 outline-none duration-200 focus:ring-2 focus:ring-primary/30"
                  ></textarea>
                </div>
                ...
                <button
                  ...
                  className="inline-flex font-medium text-dark bg-green-brand py-3 px-7 rounded-xl ease-out duration-200 hover:bg-opacity-90 shadow-neu-sm active:shadow-neu-inset disabled:opacity-50 disabled:cursor-not-allowed"
                >
