  ...
  return (
    <div className="flex items-center border-t border-gray-3 py-5 px-7.5">
        ...
        <div className="flex items-center justify-between gap-5">
          <div className="w-full flex items-center gap-5.5">
            <div className="flex items-center justify-center rounded-[5px] bg-gray-2 max-w-[80px] w-full h-17.5">
              <Image width={200} height={200} src={item.imgs?.thumbnails[0] ?? "/placeholder-img-product.jpg"} alt="product" />
            </div>
      ...
      <div className="min-w-[180px]">
        <p className="text-dark">S/. {(item.discountedPrice || item.price).toFixed(2)}</p>
      </div>
      ...
      <div className="min-w-[200px]">
        <p className="text-dark">S/. {((item.discountedPrice || item.price) * quantity).toFixed(2)}</p>
      </div>
