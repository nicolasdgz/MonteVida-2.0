...
const CartSidebarModal = () => {
  ...
  return (
    <div
      ...
      className={`fixed top-0 left-0 z-99999 overflow-y-auto w-full h-screen bg-dark/70 ease-linear duration-300 ${
        ...
        <div className="w-full max-w-[500px] shadow-1 bg-white px-4 sm:px-7.5 lg:px-11 relative modal-content">
          <div className="sticky top-0 bg-white flex items-center justify-between pb-7 pt-4 sm:pt-7.5 lg:pt-11 border-b border-gray-3 mb-7.5">
            ...
            <button
              ...
              className="flex items-center justify-center transition-colors duration-150 bg-meta text-dark-5 hover:text-dark focus:outline-2 focus:outline-offset-2 focus:outline-primary/60"
            >
              <svg
          ...
          <div className="h-[66vh] overflow-y-auto scrollbar-thin">
          ...
          <div className="border-t border-gray-3 bg-white pt-5 pb-4 sm:pb-7.5 lg:pb-11 mt-7.5 sticky bottom-0">
            <div className="flex items-center justify-between gap-5 mb-6">
              ...
              <p className="font-medium text-xl text-dark">S/. {totalPrice}</p>
            </div>
            ...
            <div className="flex items-center gap-4">
              <Link
                onClick={() => closeCartModal()}
                href="/cart"
                className="w-full flex justify-center font-medium text-white bg-primary py-[13px] px-6 rounded-md transition-colors duration-200 hover:bg-primary-dark focus:outline-2 focus:outline-offset-2 focus:outline-primary/60"
              >
                Ver Carrito
              </Link>
              ...
              <Link
                href="/checkout"
                onClick={closeCartModal}
                className="w-full flex justify-center font-medium text-white bg-accent py-[13px] px-6 rounded-md transition-colors duration-200 hover:bg-accent-dark focus:outline-2 focus:outline-offset-2 focus:outline-accent/60"
              >
                Ir a Comprar
              </Link>
            </div>
