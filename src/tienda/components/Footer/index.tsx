        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-center pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[400px] w-full text-white">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-4.5 hover:text-green-brand duration-200"
                >
                  <svg
                    width="24"
                    height="24"
            ...
            <div className="flex items-center gap-4 mt-7.5">
              ...
              <a
                href="http://instagram.com/montevida.pe"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="w-full sm:w-auto text-white">
            ...
            <ul className="flex flex-col gap-3">
              <li>
                <Link className="ease-out duration-200 hover:text-green-brand text-white" href="/terminos-y-condiciones">
                  Términos y Condiciones
                </Link>
              </li>
              <li>
                <Link className="ease-out duration-200 hover:text-green-brand text-white" href="/politica-de-privacidad">
                  Política de Privacidad
                </Link>
              </li>
              <li>
                <Link className="ease-out duration-200 hover:text-green-brand text-white" href="/politica-de-garantia">
                  Política de Garantía
                </Link>
              </li>
              <li>
                <Link className="ease-out duration-200 hover:text-green-brand text-white" href="/politica-de-envios">
                  Política de Envíos
                </Link>
              </li>
            </ul>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-center text-white">
            <p className="text-white font-medium opacity-80">
              &copy; <span suppressHydrationWarning>{year}</span> Todos los derechos reservados{" "}
              <Link href="/" className="hover:text-green-brand duration-200">&quot;MonteVida.Pe&quot;</Link>.
            </p>
