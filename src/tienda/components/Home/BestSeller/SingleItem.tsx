...
const SingleItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden rounded-3xl bg-surface min-h-[403px] shadow-neu">
        ...
        <div className="flex justify-center items-center">
          <Image src={item.imgs?.previews[0] ?? "/placeholder-img-product.jpg"} alt="" width={280} height={280} />
        </div>
        ...
        <div className="absolute right-0 bottom-0 translate-x-full u-w-full flex flex-col gap-2 p-5.5 ease-linear duration-300 group-hover:translate-x-0">
          <button
            ...
            id="bestOne"
            className="flex items-center justify-center w-9 h-9 rounded-xl shadow-neu-sm ease-out duration-200 text-dark bg-surface hover:text-white hover:bg-primary"
          >
            <svg
