    ...
    <section className="overflow-hidden pt-15">
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div className="mb-7 flex items-center justify-between">
          ...
          <Link
            href="/tienda"
            className="inline-flex font-medium text-custom-sm py-2.5 px-7 rounded-md border-transparent border bg-green-brand text-black ease-out duration-200 hover:opacity-90"
          >
            Ver Todo
          </Link>
        </div>
